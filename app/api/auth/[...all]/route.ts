...
async function proxyToNeonAuth(req: NextRequest) {
  ...
  try {
    ...
    res.headers.forEach((value, key) => {
      // Forward all cookies and headers from Neon Auth to localhost
      if (key.toLowerCase() === "set-cookie") {
        // Rewrite cookie domain/path so browser accepts on localhost
    ...
    // If Neon Auth wants to redirect
